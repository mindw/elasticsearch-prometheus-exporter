...
|---------------|---------|--------------|
| 9.5.4         | 9.5.4.0 | Sep 18, 2026 |
| 9.5.3         | 9.5.3.0 | Sep 06, 2026 |
| 9.5.2         | 9.5.2.0 | Aug 24, 2026 |
| 9.5.1         | 9.5.1.0 | Aug 14, 2026 |
| 9.4.5         | 9.4.5.0 | Aug 14, 2026 |
| 9.4.3         | 9.4.3.0 | Jul 03, 2026 |
| 9.4.2         | 9.4.2.0 | May 30, 2026 |
| 9.4.1         | 9.4.1.0 | May 29, 2026 |
...
./bin/elasticsearch-plugin install -b \
  https://github.com/mindw/elasticsearch-prometheus-exporter/releases/download/9.5.4.0/prometheus-exporter-9.5.4.0.zip
```
