...
`./bin/elasticsearch-plugin install -b https://github.com/mindw/elasticsearch-prometheus-exporter/releases/download/7.17.12.0/prometheus-exporter-7.17.12.0.zip`
