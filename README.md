...
|---------------|----------|--------------|
| 8.19.9        | 8.19.9.0 | Dev 20, 2025 |
| 8.19.8        | 8.19.8.0 | Dev 05, 2025 |
...
./bin/elasticsearch-plugin install -b \
  https://github.com/mindw/elasticsearch-prometheus-exporter/releases/download/8.19.9.0/prometheus-exporter-8.19.9.0.zip
```
